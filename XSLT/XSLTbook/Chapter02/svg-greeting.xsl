...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="/">
		<svg:svg width="10cm" height="4cm">
			<svg:g>
				<svg:defs>
					<!-- In the book, the line below also contains cx="4cm" cy="2cm" r="3cm" fx="4cm" fy="2cm"
					However, when I included that line, the svg did not output with the gradient. Since the book was published in 2008 .svg has changed alot, (like now
					browsers support .svg natively without needing a plugin). -->
